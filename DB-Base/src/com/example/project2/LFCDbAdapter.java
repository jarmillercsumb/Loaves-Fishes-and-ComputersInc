...
public class LFCDbAdapter {
   ...
   /* public Cursor fetchNote(long rowId) throws SQLException {
    ...
    protected StepsList getStepsList (String jsonString){
    	StepsList pl = null;
    	Gson gson = new Gson();
    	pl = gson.fromJson(jsonString, StepsList.class);
    	return pl;
    }
	...
	class StepsList {
		...
		private List<StepContainer> steps = new ArrayList<StepContainer>();
		public List<StepContainer> getStepsContainerList() {
			return steps;
		}
	}
    ...
    protected ClassesList getClassList (String jsonString){
    	ClassesList pl = null;
    	Gson gson = new Gson();
    	pl = gson.fromJson(jsonString, ClassesList.class);
    	return pl;
    }
	...
	class ClassesList {
		...
		private List<ClassContainer> classes = new ArrayList<ClassContainer>();
		public List<ClassContainer> getClassesContainerList() {
			return classes;
		}
	}
